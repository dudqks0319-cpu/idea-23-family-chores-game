...
import 'package:app_23_family_chores_game/app.dart';
import 'package:app_23_family_chores_game/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('가족 집안일 게임화'), findsWidgets);
